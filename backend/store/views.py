...
from store.serializers import CartSerializer, CartOrderItemSerializer, ProductSerializer, TagSerializer, CategorySerializer, CartOrderSerializer, GallerySerializer, BrandSerializer, ProductFaqSerializer, ReviewSerializer, SpecificationSerializer, ColorSerializer, SizeSerializer, AddressSerializer, WishlistSerializer, ConfigSettingsSerializer
...
class ConfigSettingsDetailView(APIView):
    def get(self, request):
        return Response({"message": "Config settings detail"})
